// TODO : Why is Whitechapel on the board twice
// TODO : Why is fast travel off by 1 place?
// TODO: Could I use the displaySquares to fast travel to next player and run set up?
class Square {
...
$(() => {
  ...
  function rollDice() {
    ...
    currentSquare = currentPlayer.location;
    console.log(`${currentPlayer.name} is on ${board[currentPlayer.location].name}`);
